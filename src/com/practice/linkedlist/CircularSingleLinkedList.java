...
public class CircularSingleLinkedList {
	...
	private SingleNode createCircularSingleList(int nodeValue) {
		head = new SingleNode();
	...
	private void insertInSingleCircularLL(int nodeValue, int location) {
		SingleNode node = new SingleNode();
		node.setValue(nodeValue);
	...
	private boolean searchNode(int nodeValue) {
		if (existsLinkedList()) {
			SingleNode tempNode = head;
			for (int i = 0; i < size; i++) {
	...
	public static void main(String[] args) {
		...
		list.createCircularSingleList(5);
		list.traverseLinkedList();

		list.insertInSingleCircularLL(10, 1);
		list.insertInSingleCircularLL(20, 2);
		list.insertInSingleCircularLL(30, 3);
		list.insertInSingleCircularLL(40, 4);

		System.out.println("Linked List now: ");
		list.traverseLinkedList();

		list.insertInSingleCircularLL(35, 4);
		list.traverseLinkedList();

		list.insertInSingleCircularLL(1, 0);
		list.traverseLinkedList();

		list.insertInSingleCircularLL(100, 10);
		list.traverseLinkedList();
